...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="panel-body">
            <div class="form">
                <form action="{{ isset($pengalaman_kerja) ? route('pengalaman_kerja.update',$pengalaman_kerja->id) 
                : route('pengalaman_kerja.store') }}" class="form-validate form-horizontal" 
                id="pengalaman_kerja_form" method='POST'>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <button class="btm btn-default" type="button"> Cancel</button> 
                            </a>
                        </div>
                    </div>
                </form>
