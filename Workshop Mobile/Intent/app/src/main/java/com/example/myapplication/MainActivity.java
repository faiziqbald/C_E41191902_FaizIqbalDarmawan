    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.buttonPindahActivityDenganData:
                ...
                moveWithDataIntent.putExtra("extra_name", "Buutttt");
                moveWithDataIntent.putExtra("extra_age", 2);
            ...
            case R.id.buttonDialNumber:
                String phoneNumber = "082131060022";
            ...
            case R.id.buttonShare:
                ...
                break;
            case R.id.buttonSMS:
                Intent sms = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto: 082131060022"));
                sms.putExtra("sms_body", "Tes tes, Assalamualaikum");
                startActivity(sms);
                break;
